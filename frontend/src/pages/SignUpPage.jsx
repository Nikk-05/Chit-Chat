...
const SignUpPage = () => {
  ...
  const { isSigningUp, signUpHandler} = useAuthState();
        ...
        <div className="w-full lg:w-1/2 flex flex-col p-6 sm:p-10">
                ...
                >{
                    isSigningUp ? (
                      <span className='flex justify-center items-center '>
                        <Loader2 className='size-5 animate-spin mx-2' /> Signing Up...
                      </span>) : "Sign Up"
                  }
                </button>
              </Form>
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-gray-600">
              ...
              <Link to="/login" className="ml-2 text-sm font-semibold text-black hover:underline">
                Log In
              </Link>
            </p>
          </div>
